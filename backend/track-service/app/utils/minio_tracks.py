...
class MinIOClient:
    def __init__(self):
        ...
        self.bucket = os.getenv("MINIO_TRAKCS_BUCKET", "tracks")
    ...
    def upload_track(self, file, track_id: int, track_title: str, file_extension: str):
    ...
    def get_track_url(self, object_name: str):
        try:
            return self.client.presigned_get_object(
                self.bucket, object_name, expires=timedelta(seconds=86400)  # 1 hour
            )
    ...
    def delete_track(self, object_name: str):
        try:
...
minio_track_client = MinIOClient()
